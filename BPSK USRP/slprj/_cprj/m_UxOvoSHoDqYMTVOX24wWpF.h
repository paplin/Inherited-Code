#ifndef __UxOvoSHoDqYMTVOX24wWpF_h__
#define __UxOvoSHoDqYMTVOX24wWpF_h__
...
/* Type Definitions */
#ifndef struct_tag_xmD6qNtx4CAic486GVYHNE
#define struct_tag_xmD6qNtx4CAic486GVYHNE

struct tag_xmD6qNtx4CAic486GVYHNE
{
  real_T f1;
  real_T f2;
  real_T f3;
...
#endif                                 /*struct_tag_xmD6qNtx4CAic486GVYHNE*/

#ifndef typedef_s_xmD6qNtx4CAic486GVYHNE
#define typedef_s_xmD6qNtx4CAic486GVYHNE

typedef struct tag_xmD6qNtx4CAic486GVYHNE s_xmD6qNtx4CAic486GVYHNE;

#endif                                 /*typedef_s_xmD6qNtx4CAic486GVYHNE*/
...
#ifndef struct_tag_snr93b8PhhDUiZM0n6OCpC
#define struct_tag_snr93b8PhhDUiZM0n6OCpC

struct tag_snr93b8PhhDUiZM0n6OCpC
{
  s_xmD6qNtx4CAic486GVYHNE _data;
};

#endif                                 /*struct_tag_snr93b8PhhDUiZM0n6OCpC*/

#ifndef typedef_s_snr93b8PhhDUiZM0n6OCpC
#define typedef_s_snr93b8PhhDUiZM0n6OCpC

typedef struct tag_snr93b8PhhDUiZM0n6OCpC s_snr93b8PhhDUiZM0n6OCpC;

#endif                                 /*typedef_s_snr93b8PhhDUiZM0n6OCpC*/
...
#ifndef struct_tag_HYIluNPVHcMIhYwYdde1JF
#define struct_tag_HYIluNPVHcMIhYwYdde1JF

struct tag_HYIluNPVHcMIhYwYdde1JF
{
  char_T f1[4];
  char_T f2[6];
  char_T f3[8];
...
#endif                                 /*struct_tag_HYIluNPVHcMIhYwYdde1JF*/

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_HYIluNPVHcMIhYwYdde1JF cell;
...
#ifndef struct_tag_qXE9mkJ0DUVcRyWOBN3giE
#define struct_tag_qXE9mkJ0DUVcRyWOBN3giE

struct tag_qXE9mkJ0DUVcRyWOBN3giE
{
  cell _data;
};

#endif                                 /*struct_tag_qXE9mkJ0DUVcRyWOBN3giE*/

#ifndef typedef_s_qXE9mkJ0DUVcRyWOBN3giE
#define typedef_s_qXE9mkJ0DUVcRyWOBN3giE

typedef struct tag_qXE9mkJ0DUVcRyWOBN3giE s_qXE9mkJ0DUVcRyWOBN3giE;

#endif                                 /*typedef_s_qXE9mkJ0DUVcRyWOBN3giE*/
...
#ifndef struct_tag_rbvlD7ZKu3ljpWsO165YdD
#define struct_tag_rbvlD7ZKu3ljpWsO165YdD

struct tag_rbvlD7ZKu3ljpWsO165YdD
{
...
typedef struct {
  ...
  int32_T (*u0_sizes)[2];
  real_T (*u1_data)[12349];
  int32_T (*u1_sizes)[2];
  real_T (*u2_data)[12349];
  int32_T (*u2_sizes)[2];
  creal_T (*b_y0)[11226];
  boolean_T *b_y1;
} InstanceStruct_UxOvoSHoDqYMTVOX24wWpF;

#endif                                 /*typedef_InstanceStruct_UxOvoSHoDqYMTVOX24wWpF*/
...
extern void method_dispatcher_UxOvoSHoDqYMTVOX24wWpF(SimStruct *S, int_T method,
  void* data);
